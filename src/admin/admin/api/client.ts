...
export const brandApi = {
  ...
  updateIdentity: (id: string, body: unknown) => api.patch(`/admin/brand-identity/${id}`, body),
  ...
  updateMessage: (id: string, body: unknown) => api.patch(`/admin/brand-messages/${id}`, body),
  getValues: () => api.get<any[]>("/admin/brand-values"),
  createValue: (body: unknown) => api.post("/admin/brand-values", body),
  updateValue: (id: string, body: unknown) => api.patch(`/admin/brand-values/${id}`, body),
  deleteValue: (id: string) => api.delete(`/admin/brand-values/${id}`),
  getDesignerProfile: () => api.get<any[]>("/admin/designer-profile"),
  updateDesignerProfile: (id: string, body: unknown) => api.patch(`/admin/designer-profile/${id}`, body),
  getContactInfo: () => api.get<any[]>("/admin/contact-info"),
  updateContactInfo: (id: string, body: unknown) => api.patch(`/admin/contact-info/${id}`, body),
  getAboutBlocks: () => api.get<any[]>("/admin/about-content-blocks"),
  updateAboutBlock: (id: string, body: unknown) => api.patch(`/admin/about-content-blocks/${id}`, body),
};

export const collectionsApi = {
  getAll: () => api.get<any[]>("/admin/collections"),
  create: (body: unknown) => api.post("/admin/collections", body),
  update: (id: string, body: unknown) => api.patch(`/admin/collections/${id}`, body),
  delete: (id: string) => api.delete(`/admin/collections/${id}`),
};

export const productsApi = {
  getAll: () => api.get<any[]>("/admin/products"),
  getByCollection: (collectionId: string) => api.get<any[]>(`/admin/products/by-collection/${collectionId}`),
  create: (body: unknown) => api.post("/admin/products", body),
  update: (id: string, body: unknown) => api.patch(`/admin/products/${id}`, body),
...
export const upcomingEventsApi = {
  ...
  update: (id: string, body: unknown) => api.patch(`/admin/upcoming-events/${id}`, body),
...
export const pagesApi = {
  ...
  getSectionsByPage: (pageId: string) => api.get<any[]>(`/admin/page-sections/${pageId}`),
  updateSection: (id: string, body: unknown) => api.patch(`/admin/page-sections/${id}`, body),
  getSeo: () => api.get<any[]>("/admin/page-seo"),
  updateSeo: (id: string, body: unknown) => api.patch(`/admin/page-seo/${id}`, body),
  ...
  updateNavigation: (id: string, body: unknown) => api.patch(`/admin/navigation/${id}`, body),
...
export const usersApi = {
  ...
  changePassword: (body: unknown) => api.patch("/admin/users/me/password", body),
  ...
  getRolePermissions: (roleId: string) => api.get<any[]>(`/admin/users/roles/${roleId}/permissions`),
  addRolePermission: (roleId: string, body: unknown) => api.post(`/admin/users/roles/${roleId}/permissions`, body),
  deleteRolePermission: (roleId: string, permissionId: string) => api.delete(`/admin/users/roles/${roleId}/permissions/${permissionId}`),
  getUserPermissions: (userId: string) => api.get<any[]>(`/admin/users/${userId}/permissions`),
  addUserPermission: (userId: string, body: unknown) => api.post(`/admin/users/${userId}/permissions`, body),
  deleteUserPermission: (userId: string, permissionId: string) => api.delete(`/admin/users/${userId}/permissions/${permissionId}`),
};
